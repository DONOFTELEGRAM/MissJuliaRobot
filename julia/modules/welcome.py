...
from julia.modules.helper_funcs.chat_status import (
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "My master left the chat 😭", reply_to_message_id=reply
                )
                return
